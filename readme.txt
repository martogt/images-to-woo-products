...
Tags: woocommerce, products, uploader, images, bulk
...
== Description ==
**Images to Products for WooCommerce (Uploader Edition)** helps you create dozens of WooCommerce products at once.  
...
== Installation ==
1. Upload the plugin folder `images-to-products-for-woocommerce` to `/wp-content/plugins/`.
2. Activate the plugin through **Plugins → Installed Plugins**.
3. Go to **WooCommerce → Images → Products (Uploader)** and follow the UI.
